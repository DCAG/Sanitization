Describe 'Invoke-FileRedaction' {
    Context 'Parameters Validation' {
        It 'Parameter RedactionRule should not be null [Unix]' -Skip:(-not ([environment]::OSVersion.Platform -match 'Unix')) {
        ...
        It 'Parameter RedactionRule should not be null [Windows]' -Skip:(-not ([environment]::OSVersion.Platform -match 'Win')) {
